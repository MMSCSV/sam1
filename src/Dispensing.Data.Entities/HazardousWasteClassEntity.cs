...
{
    public partial class HazardousWasteClassEntity : IContractConvertible<HazardousWasteClass>
    {
        ...
        [Association(Name = "FacilityEntity_HazardousWasteClassEntity", Storage = "_facilityEntity", ThisKey = "FacilityKey", OtherKey = "Key", IsForeignKey = true)]
        ...
        #region IContractConvertible<HazardousWasteClass> Members

        public HazardousWasteClass ToContract()
        {
            return new HazardousWasteClass(Key)
                {
                    DisplayCode = DisplayCode,
                    Description = DescriptionText,
                    DisposalInstructions = DisposalInstructionsText,
