...
namespace CareFusion.Dispensing.Contracts
{
    ...
    /// </summary>
    public class DisplayPatientOnRemoveIdentifier
    {
        ...
        public static Guid DisplayIdIdentifierKey = Guid.Parse("3fd91c4e-91c2-454a-ad2f-59a1f43dabdb");
        ...
        public bool DisplayMedicationLabelId
        {
            get { return Key == DisplayIdIdentifierKey; }
        }
        ...
        public Guid? PatientIdentifierTypeKey
        {
            get
            {
                return (DisplayMedicationLabelId || DisplayAccountIdentifier || DisplayAlternateEncounterIdentifier || DisplayEncounterIdentifier || Key == Guid.Empty) ? default(Guid?) : Key;
            }
        }
        #endregion
    }
